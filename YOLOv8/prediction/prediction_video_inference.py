...
if __name__ == "__main__":
    ...
    with open('./output/' + file_name + '_count_m.csv', 'w', newline='') as count_file:
        fieldnames = ['Car', 'Van', 'Truck', 'Pedestrian', 'Person_sitting', 'Cyclist', 'Tram', 'Misc', 'DontCare' , 'Total', 'Inference']
        ...
        while True:
            ...
            if success:
                ...
                count_dict['Inference'] = results[0].speed['inference']
